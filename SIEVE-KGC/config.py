...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser("SimKGC-SIEVE (RAA-style integration)")
    ...
    # Encoder / SimKGC contrastive learning.
    # Defaults follow the public RAA-KGC SimKGC setup as closely as practical.
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=True,
        help="Use both query->tail and tail->query in-batch CE, matching RAA-KGC code.",
    )
    ...
    parser.add_argument("--output_dir", default="checkpoint/simkgc_sieve_raastyle")
    ...
    # RAA-style SIEVE integration.
    # SIEVE is an auxiliary query branch, not a direct top-K score bonus.
    parser.add_argument("--use_sieve", type=str2bool, default=True)
    parser.add_argument("--sieve_train", type=str2bool, default=True)
    parser.add_argument("--sieve_eval", type=str2bool, default=True)
    parser.add_argument(
        "--sieve_aux_weight",
        type=float,
        default=0.20,
        help="Weight of the SIEVE-enhanced query contrastive loss; RAA code uses 0.2.",
    )
    parser.add_argument(
        "--sieve_eval_weight",
        type=float,
